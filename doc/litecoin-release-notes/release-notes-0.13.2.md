Elspero Core version 0.13.2 is now available from:
  ...
  <https://download.elspero.org/elspero-0.13.2.1/>
...
Then, to tunnel a SSL connection on 28392 to a RPC server bound on localhost on port 19334 do:

    stunnel -d 28392 -r 127.0.0.1:19334 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /elsperorpc>
        ProxyPass http://127.0.0.1:8392/
        ProxyPassReverse http://127.0.0.1:8392/
